    ...
    if (compact) {
        return (
            <>
                ...
                {hasAttended ? (
                    <Button size="sm" className="bg-gradient-to-r from-amber-500 to-orange-500 text-foreground border-0 hover:from-amber-600 hover:to-orange-600"
        ...
        <>
            ...
            <Card className="border-amber-500/20 bg-gradient-to-br from-amber-500/5 to-orange-500/5">
                <CardContent className="flex items-center gap-4 p-4">
                    ...
                    {hasAttended ? (
                        <Button size="sm" className="bg-gradient-to-r from-amber-500 to-orange-500 text-foreground border-0"
                            onClick={generateCertificate} disabled={generating}>
                            <Download className="h-3.5 w-3.5 mr-1" />
                            {generating ? "..." : "Download"}
                        </Button>
