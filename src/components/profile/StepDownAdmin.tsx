    ...
    return (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8 pt-8 border-t-2 border-border">
            <div className="space-y-2">
                <label className="text-[10px] font-[900] uppercase tracking-widest text-destructive flex items-center gap-2">
                    <AlertTriangle className="h-4 w-4" /> DANGER ZONE
                </label>
                <p className="text-xs text-muted-foreground font-[900] uppercase tracking-widest">LEAVE ADMIN ROLE</p>
            </div>
            ...
            <div className="bg-destructive/[0.03] border-2 border-destructive/20 rounded-[32px] p-8 space-y-6">
                <div>
                    ...
                    <p className="text-sm font-[500] text-muted-foreground mt-2 leading-relaxed">
                ...
                <div className="pt-4 border-t border-destructive/10">
                    <button 
                        ...
                        className="h-14 px-8 bg-destructive text-destructive-foreground rounded-full font-[900] text-[10px] uppercase tracking-widest hover:brightness-110 transition-all disabled:opacity-50 flex items-center gap-2"
                    >
